...
function makeJobs(items: string[]) {
...
export default function MechanicJobListPage() {
  ...
  const [specialJobs, setSpecialJobs] = useState<Job[]>(
    SPECIAL_JOBS[0] === "No special jobs released for this car"
      ? []
  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <h1 className="mt-3 text-4xl font-semibold">Job List</h1>

        <p className="mt-3 max-w-2xl text-sm text-zinc-400">
          Complete the released job list for this car. Jobs can only be changed
