...
async function generatePostEventPdf({
  ...
  drawText(`Car ${carId} Post-Event Sheet`, 40, height - 62, 24, boldFont, rgb(1, 1, 1));
  ...
  drawText("Post-event sheet generated by Rodin Motorsport Mechanics Hub", 40, 50, 8, regularFont, grey);
...
export default function PostEventSheetPage() {
  ...
  async function saveSheet() {
    ...
    try {
      ...
      const { error: insertError } = await supabase.from("post_event_sheets").insert({
        car_id: carId,
